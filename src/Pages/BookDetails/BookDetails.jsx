...
const BookDetails = () => {
 ...
 const handleMarkAsRead = (id) =>{
    ...
    // where to store
    // array or collection
    // check if book already exist or not
    addToStoreDb(id)
 }
  ...
  return (
    <div className="w-11/12 md:w-3/4 lg:w-2/3 mx-auto my-8 p-8 bg-white shadow-lg rounded-2xl border border-gray-100">
      ...
      <div className="flex flex-wrap gap-4 mt-6">
        <button onClick={()=>handleMarkAsRead(id)} className="px-5 py-2 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition-all">
          Mark as Read
        </button>
